				...
				<div class="card" style="margin-top:5%">
					...
					<div class="card-body">
						<table class="table table-hover" id="data" align="center">
							...
							<tbody>
								<?php 
									$sql = mysql_query("SELECT * FROM tbl_tagihan WHERE id_pelanggan = '$_SESSION[username]' AND status = '-' ORDER BY tahun, bulan ASC");
								 ...
								 <tr>
								 	...
								 	<th scope="col" class="text-center"><a href="?menu=bayar&id=<?php echo $data['id_tagihan'] ?>">Bayar</a></th>
								 </tr>
								 <?php } ?>
							</tbody>
						</table>

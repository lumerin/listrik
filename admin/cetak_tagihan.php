		...
		<table cellspacing="1" width="90%" align="center" border="1">
			...
			<tbody>
				<?php 
					...
					$sql = mysql_query("SELECT * FROM query_tagihan WHERE bulan = '$_GET[id_bulan]' ORDER BY id_tagihan ASC");
				} elseif ($_GET['id_bulan'] == "") {
					$sql = mysql_query("SELECT * FROM query_tagihan WHERE tahun = '$_GET[id_tahun]' ORDER BY id_tagihan ASC");
				} else {
					$sql = mysql_query("SELECT * FROM query_tagihan WHERE bulan = '$_GET[id_bulan]' AND tahun = '$_GET[id_tahun]' ORDER BY id_tagihan ASC");
				}
